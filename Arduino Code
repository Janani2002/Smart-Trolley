...
const char* ssid = "Ruthul";//Replace with your network SSID
const char* password = "ruthul2002";//Replace with your network password
...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    if (count == 12)
    {
      if ((strncmp(input, "4E00476D7713", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "4E00476D7713", 12) == 0) && (a == 0))
      {
        if(p1>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "4E004789E363", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "4E004789E363", 12) == 0) && (a == 0))
      {
         if(p2>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "4E00477BAAD8", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "4E00477BAAD8", 12) == 0) && (a==0))
      {
        if(p3>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "4E0020EB6FEA", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "4E0020EB6FEAx`", 12) == 0) && (a == 0))
      {
        if(p4>0)
        {
        lcd.clear();
      ...
      else if (strncmp(input, "4E0047D5924E", 12) == 0)
      {
        lcd.clear();
        lcd.setCursor(0, 0);
